...
class ViewControllerSub: UIViewController {
    ...
    @IBOutlet weak private var descriptionStyle: UILabel!
    
    override func viewDidLoad() {
        super.viewDidLoad()
    }

    public func setDescriptionStyle(_ stylesValue:[String:Float]){
        print(descriptionStyle.text)
        ...
        self.descriptionStyle.text="Your possible style is " + possibleStyle + " - " //+ percentagePair[possibleStyle]! + getAdvice(possibleStyle)
